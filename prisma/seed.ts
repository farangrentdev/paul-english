...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    create: {
      ...
      aboutBody: J([
        "Стал победителем конкурса «Педагоги года Москвы 2026», защищал регион на всероссийском конкурсе, но горжусь не дипломами, а тем, что мои ученики перестают бояться открыть рот. За 10 лет через меня прошли три сотни человек — от семилеток до директоров, которым английский нужен «ещё вчера».",
      ...
      footerLegal: "© 2026 Paul English · ИП Петров П. П. · ИНН 000000000000",
    },
  });
